...
<% else -%>
    ...
    grow=down,
    level 1/.append style={sibling distance=6.5cm, level distance=3cm},
    level 2/.append style={sibling distance=3.5cm, level distance=3cm},
    level 3/.append style={sibling distance=2cm, level distance=3cm},
    <% elif layout_mode == 'horizontal' -%>
    <% if lang == 'ar' %>grow=left,<% else %>grow=right,<% endif %>
    level 1/.append style={sibling distance=4cm, level distance=5.5cm},
    level 2/.append style={sibling distance=2.5cm, level distance=5cm},
    level 3/.append style={sibling distance=1.5cm, level distance=4.5cm},
    <% endif -%>
    every node/.style={
