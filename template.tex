...
% The Arabic font is loaded regardless of the chosen language, so RTL text
% can still be embedded inside an English map.
<% if arabic_font == bundled_font_label or not arabic_font -%>
\newfontfamily\arabicfont[Path=<< font_dir >>, Script=Arabic]{<< bundled_font_file >>}
<% else -%>
\IfFontExistsTF{<< arabic_font >>}{
  \newfontfamily\arabicfont[Script=Arabic]{<< arabic_font >>}
}{
  \newfontfamily\arabicfont[Path=<< font_dir >>, Script=Arabic]{<< bundled_font_file >>}
}
<% endif -%>
